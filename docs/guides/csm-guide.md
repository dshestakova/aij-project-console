...
> **Важно:** цель — получить высокий уровень инновационности. Если система выставила средний или низкий уровень, доработайте формулировки проблемы, решения и инновационности вручную.
...
[Скриншот: блок автозаполнения паспорта до запуска]
...
[Скриншот: результат автозаполнения — проблема, решение, инновационность]
...
[Скриншот: статус «Описание загружено»]
