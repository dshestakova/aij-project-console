...
Дополнительно доступны статус флагмана, автоматическая оценка инновационности, признаки **«Загружен на ПРБР»** и **«Одобрен ЦА»**, а также поля **«Описание проблемы»**, **«Предлагаемое решение»** и **«Функциональность GenAI / AI»**. Текстовые результатные поля можно проверить и отредактировать вручную, а уровень инновационности определяет только система.

![Флагманский блок с исходными полями описания](assets/17-flagship-source-fields.png)

## 6. Автозаполнение паспорта флагманского проекта
...
> **Важно:** цель — высокий уровень инновационности. Если после автозаполнения уровень средний или низкий, доработайте исходные данные, поля «Описание проблемы», «Предлагаемое решение» и «Функциональность GenAI / AI», затем повторите автозаполнение. CSM не выставляет уровень инновационности вручную.

> **Ответственность CSM:** автозаполнение помогает подготовить паспорт, но CSM отвечает за смысловую проверку результата.

### 6.2. Что нужно заполнить перед автозаполнением
...
### 6.3. Как запустить автозаполнение
...
### 6.4. Что система заполнит автоматически
...
- **Инновационность** — автоматически рассчитанный уровень **«высокий»**, **«средний»** или **«низкий»**;
...
### 6.6. Как довести инновационность до высокого уровня

Если автоматическая оценка показала **«средний»** или **«низкий»** уровень:
...
3. Уточните восемь исходных полей, если в них не хватает отличий от текущего процесса, роли AI, масштаба эффекта или данных.
4. Нажмите **«Сохранить»**.
5. Снова запустите **«Автозаполнить паспорт»**, чтобы система выполнила новую оценку инновационности.
6. Проверьте новый автоматически рассчитанный уровень. При необходимости повторите доработку или обратитесь к аналитику.

CSM не выбирает и не повышает уровень инновационности вручную. Значение формируется исключительно по результатам автоматической оценки обновленного описания.

### 6.7. Что означает «Описание загружено»
...
7. Проверьте **«Описание проблемы»**, **«Предлагаемое решение»** и автоматически рассчитанную **«Инновационность»**.
8. Если инновационность не высокая, улучшите исходные данные и текстовые формулировки проблемы, решения и функциональности.
9. Нажмите **«Сохранить»** и повторно запустите автозаполнение для новой автоматической оценки.
10. Убедитесь, что система рассчитала актуальный уровень, отображается **«Описание загружено»** и сохранена новая версия паспорта.
...
- **Инновационность средняя или низкая.** Используйте обоснование оценки, улучшите исходные и текстовые поля, сохраните карточку и повторите автозаполнение. Не меняйте уровень вручную.
