          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                Новых пользователей пока нужно создавать в Supabase Auth. Здесь
                можно управлять ролями уже созданных профилей.
              </p>
            </div>
          ...
          {error ? (
            ...
            <section className="rounded-lg border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
              ...
              <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">
                Создайте пользователя в Supabase Auth и добавьте профиль в
                public.profiles, чтобы управлять ролью здесь.
              </p>
            </section>
          ) : (
